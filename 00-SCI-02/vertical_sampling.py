...
while row_num <= 119:
    ...
    x.append(sheet1.cell(row=row_num, column=1).value)
    y.append(sheet1.cell(row=row_num, column=2).value)
    row_num = row_num + 1
...
plt.savefig(r'vertical_sampling.svg', bbox_inches='tight', dpi=600)
plt.show()
